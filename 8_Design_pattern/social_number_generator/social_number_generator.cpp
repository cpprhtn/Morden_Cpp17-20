//사회보장정보 생성 프로그램 구현
/*
북쪽 나라와 남쪽나라, 두 국가의 사회보장정보를 생성하는 프로그램을 작성
- 두 국가의 번호 형식은 서로 유사하지만 약간의 차이가 있음
    - 북쪽 나라의 사회보장번호의 형식은 SYYYYMMDDNNNNNC
        - S : sex {7:boy, 9:girl}
        - YYYYMMDD : 생년월일
        - N : 난수 (5자리) 
        - C : 체크섬을 11의 배수로 만들기 위한 숫자

    - 남쪽 나라의 사회보장번호의 형식은 SYYYYMMDDNNNNC
        - S : sex {2:boy, 1:girl}
        - YYYYMMDD : 생년월일
        - N : 난수 (4자리) 
        - C : 체크섬을 10의 배수로 만들기 위한 숫자

C(체크섬) : 각 자리 수에 가중치를 곱한 것의 합
*/
