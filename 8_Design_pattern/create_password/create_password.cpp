//임의의 패스워드를 생성하는 프로그램 구현
/*
사전 정의된 규칙에 따라 임의의 패스워드를 생성하는 프로그램 작성
- 각 패스워드는 설정한 최소 길이 이상이어야 함
- 패스워드는 하나 이상의 숫자나 기호, 대문자, 소문자 등을 포함해야 하는 것처럼 여러 다른 생성 규칙을 포함할 수도 있어야 함.
- 추가된 규칙들은 사용자가 설정하고 조합할 수 있어야 함
*/
